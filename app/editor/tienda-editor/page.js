			...
			<main className="main-container-editor">
				<div className="main-section-editor">
					<div className="title-and-logo-div-editor">
						...
						<Zoom>
							<h1 className="h1-page">Editor de Sección Tienda</h1>
						</Zoom>
					</div>
					...
					<section className="current-imgs-container-editor">
						{!PostgreRes?.products.length ? (
							...
							PostgreRes?.products.map((product) => {
								let { id, title, price, stock, images } = product;
								price = price.toLocaleString("es-CL", {
									style: "currency",
									currency: "CLP",
								});
								return (
									<div key={id} className="product-div-editor">
										<Image
											src={images[0].url}
											width={300}
											height={300}
										...
										/>
										<div className="text-div-product-editor">
											<h1>{title}</h1>
											<h2>{price}</h2>
										...
										<div className="buttons-div-product-editor">
											...
											<Link
												href={`/editor/editar-producto/${id}`}
