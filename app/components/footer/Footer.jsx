...
import MyModalLogin from "../modalLogin/ModalLogin";
...
const Footer = () => {
	...
	const [modalLoginImage, setModalLoginImage] = useState();
	const [modalLoginTitle, setModalLoginTitle] = useState("");
	...
	function handleSubmit(e) {
		...
		if (!asunto || !msje) {
			setModalTitle("¡Oops!");
			setModalMessage(
				"Lo sentimos, pero no puedes dejar el asunto o el mensaje vacíos."
			);
			setModalImage("/img/oops.webp");
			setModal(true);
			return;
		}
